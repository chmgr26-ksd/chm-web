...
export const PERMISSIONS = {
  ...
  'posts:manage':     ROLES.STAFF, // 소식·게시판 작성/수정/삭제
  'events:manage':    ROLES.STAFF, // 이벤트·행사 작성/수정/삭제
  'faqs:manage':      ROLES.STAFF, // FAQ 작성/수정/삭제
  'gallery:manage':   ROLES.STAFF, // 갤러리(아카이브) 이미지 업로드/삭제
  'reviews:manage':   ROLES.STAFF, // 후기(집수리 교실·체험) 등록/수정/삭제
  'resources:manage': ROLES.STAFF, // 자료실 문서 업로드/수정/삭제
  'qna:manage':       ROLES.STAFF, // QNA 게시판 답변/공개/삭제
