...
import { getSiteImageVersions, getRecentNotices, getNoticeHeroConfig, siteImageUrl } from '@/lib/siteContent';
...
export default async function LandingPage() {
  const [versions, notices, noticeConfig] = await Promise.all([
