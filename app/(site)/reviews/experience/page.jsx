...
export const metadata = { title: '집수리 체험 후기', description: '집수리 체험에 참여한 분들의 후기입니다.' };

// 집수리 체험 후기 — 골격(향후 후기 데이터 연동). 후기 모집은 구글 폼으로.
export default function ExperienceReviewsPage() {
  return (
    <>
      <PageBanner eyebrow="Reviews" title="집수리 체험 후기" description="집수리 체험에 참여한 분들의 후기입니다." />
        ...
        <Container size="md" className="py-16">
          <div className="rounded-chm-xl border border-border bg-surface-muted p-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-body text-ink-600">
              집수리 체험에 참여하셨다면 소중한 후기를 남겨주세요. 등록된 후기는 이 페이지에 순차적으로 소개됩니다.
            </p>
            <div className="mt-6">
